    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-amber-600 via-orange-500 to-red-700 items-center justify-center p-12">
        <div className="text-center text-white max-w-sm">
          ...
          <p className="mt-6 text-white/75 text-base leading-relaxed">Deine Familie wartet.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:max-w-lg mx-auto">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-stone-50">{t('loginTitle')}</h1>
            <p className="text-base text-gray-600 dark:text-stone-400 mt-1 leading-relaxed">{t('loginSubtitle')}</p>
          </div>
          ...
          <div className="mt-4 flex flex-col items-center gap-2">
            ...
            {!magicMode && (
              <Link
                ...
                className="text-sm text-gray-500 dark:text-stone-400 hover:text-amber-600 dark:hover:text-amber-400"
              >
                {t('forgotPassword')}
              </Link>
            )}
