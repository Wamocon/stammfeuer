  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-10 text-base leading-relaxed text-gray-700 dark:text-stone-300">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 2 Vertragsschluss</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 3 Leistungsbeschreibung</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 4 Nutzungsrechte</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 5 Pflichten des Nutzers</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 6 Verfügbarkeit</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 7 Datenschutz</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 8 Kündigung</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">§ 9 Haftungsbeschränkung</h2>
          <p>
