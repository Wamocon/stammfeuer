  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-stone dark:prose-invert max-w-none space-y-8 text-base leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">WAMOCON GmbH</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Vertretungsberechtigter Geschäftsführer</h2>
          <p className="text-gray-700 dark:text-stone-300">Dipl.-Ing. Waleri Moretz</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Registereintrag</h2>
          <p className="text-gray-700 dark:text-stone-300">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-3">Angaben zum Angebot</h2>
          <p className="text-gray-700 dark:text-stone-300">
